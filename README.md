...
Для кулиба:
Моды на раст : мод на карточки, модельки дверей, улучшение построек, механика рейдов, модельки ящиков, взять мод на команды из батлкрафта и сделать из них "зеленку" (пати) ну или свой сделать, изменение отдачи на типо растовску (мб)
