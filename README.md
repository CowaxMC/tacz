...
Для кулиба:
Моды на раст, дилдак в пердак, : мод на карточки, модельки дверей, улучшение построек, механика рейдов, модельки ящиков, взять мод на команды из батлкрафта и сделать из них "зеленку" (пати)
